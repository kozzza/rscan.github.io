...
### Transparency
The backend and frontend of the app are opensourced at [src128](https://github.com/kozzza/src128) and [rscan](https://github.com/kozzza/rscan). All code at these repositories is up to date and uses CD to deploy the backend as soon as new code is pushed.
